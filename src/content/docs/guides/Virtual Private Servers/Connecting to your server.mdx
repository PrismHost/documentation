...
description: This guide will teach you how to connect to your new VPS.
---
...
<Aside type="caution" title="Info!">
  If you chose to setup SSH keys upon install of the OS, you'll need to specify the key in order to connect.
</Aside>
