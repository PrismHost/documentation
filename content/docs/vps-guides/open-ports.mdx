...
Follow these steps to open ports on your Windows VPS or dedicated server using Windows Defender Firewall:
...
Choose the firewall system your Linux VPS is using and follow the corresponding instructions:
